...
class EFIT:
    ...
    def DeltaStress(self,x,y,z):
            ...
            if x == 0:
                ...
                Ds[0,0] = ((1/self.__ds) *
                    ((Lame1+2*Lame2)*(self.Gv[0,x,y,z,1]-self.Gv[0,x-1,y,z,1]) +
                        Lame1*(self.Gv[1,x,y,z,1]-self.Gv[1,x,y+1,z,1]+self.Gv[2,x,y,z,1]-self.Gv[2,x,y,z+1,1])
                        )
                    )
            elif y==0:
                Ds[0,0] = ((1/self.__ds) *
        ...
        try:
            if y == 0:
                ...
                Ds[1,1] =  ((1/self.__ds) *
                    ((Lame1+2*Lame2)*(self.Gv[1,x,y,z,1]-self.Gv[1,x,y-1,z,1]) +
        ...
        try:
            if z == 0:
                ...
                Ds[2,2] =  ((1/self.__ds) *
                    ((Lame1+2*Lame2)*(self.Gv[2,x,y,z,1]-self.Gv[2,x,y,z-1,1]) +
        ...
        try:
            if x == self.__MaxX-1 and y == self.__MaxY-1:
                Ds[0,1] =  (
                    (1/self.__ds) *
        ...
        try:
            if x == self.__MaxX-1 and z == self.__MaxZ-1:
                Ds[0,2] =  (
                    (1/self.__ds) *
            ...
            elif x == self.__MaxX-1:
                Ds[0,2] =  (
                    (1/self.__ds) *
                    (4/((1/self.Gp[2,x,y,z])+(1/self.Gp[2,x-1,y,z])+(1/self.Gp[2,x,y,z+1])+(1/self.Gp[2,x-1,y,z+1]))) *
                    (self.Gv[0,x,y,z+1,1]-self.Gv[0,x,y,z,1] +self.Gv[2,x-1,y,z,1]-self.Gv[2,x,y,z,1] )
                    )
            elif z == self.__MaxZ-1:
                Ds[0,2] =  (
                    (1/self.__ds) *
                    (4/((1/self.Gp[2,x,y,z])+(1/self.Gp[2,x+1,y,z])+(1/self.Gp[2,x,y,z-1])+(1/self.Gp[2,x+1,y,z-1]))) *
                    (self.Gv[0,x,y,z-1,1]-self.Gv[0,x,y,z,1] +self.Gv[2,x+1,y,z,1]-self.Gv[2,x,y,z,1] )
        ...
        try:
            if y == self.__MaxY -1 and z == self.__MaxZ-1:
                Ds[1,2] =  (
                    (1/self.__ds) *
    ...
    def DeltaVelocity(self, x,y,z):
        ...
        try:
            if x == self.__MaxX+1 and y == 0 and z==0:
                DV[0] = ((1 / self.__ds ) *
            ...
            elif x == self.__MaxX+1 and z==0:
                DV[0] = ((1 / self.__ds ) *
                        (2 / (self.Gp[0,x,y,z]+self.Gp[0,x-1,y,z])) *
                        (self.Gs[0,0,x-1,y,z,1] - self.Gs[0,0,x,y,z,1] + self.Gs[0,1,x,y,z,1] - self.Gs[0,1,x,y-1,z,1] + self.Gs[0,2,x,y,z,1] -self.Gs[0,2,x,y,z+1,1])
                        )
            elif x == self.__MaxX+1 and y == 0:
                DV[0] = ((1 / self.__ds ) *
                        (2 / (self.Gp[0,x,y,z]+self.Gp[0,x-1,y,z])) *
                        (self.Gs[0,0,x-1,y,z,1] - self.Gs[0,0,x,y,z,1] + self.Gs[0,1,x,y,z,1] - self.Gs[0,1,x,y+1,z,1] + self.Gs[0,2,x,y,z,1] -self.Gs[0,2,x,y,z-1,1])
                        )
    ...
    def ForcingFunctionWave(self, t, Hz = 40000, EP=100):
        ...
        EmitterWidth = 4 #int(EmitterWidth)
        ...
        self.Gv[1,StartX:StartX+EmitterWidth,self.__MaxY-1,StartZ:StartZ+EmitterWidth,1] = Temp
    ...
    def ForcingFunctionImpulse(self, force = 100, emitter = 0.01):
        ...
        self.Gv[1,StartX:StartX+EmitterWidth,self.__MaxY-2,StartZ:StartZ+EmitterWidth,1] = Temp
    ...
    def StressCut(self, Dimm, Dimm1, Dimm2, location = -1):
        ...
        if Dimm == 0:
            ...
            Component1 = self.Gs[Dimm1,Dimm2,location,:,:,1]
